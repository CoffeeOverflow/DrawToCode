...
def test_extract_value_from_cells():
    ...
    list_of_xml_classes = ["<p style=\"margin: 0px ; margin-top: 4px ; text-align: center\"><i>&lt;&lt;Interface&gt;&gt;</i><br><b>CalculoDeSalario</b></p><hr size=\"1\"><p style=\"margin: 0px ; margin-left: 4px\">+ calcular_salario_1(funcionario: Funcionario): float<br>+ calcular_salario_2(funcionario: Funcionario, carga_horaria: int): float</p>"]
